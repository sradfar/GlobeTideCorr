...
#
# Description:
# This script processes global tide-gauge records from 1950–1980 and evaluates
# co-variability among major tidal constituents (M2, N2, S2, O1, K1, MK3, MS4).
# Annual maxima are extracted for each gauge, primary and secondary constituents
# are identified, and Kendall τ correlations are computed for all stations with
# ≥20 years of data.
#
# Outputs:
# - Global Robinson-projection maps of Kendall τ correlations and significance.
# - Summary statistics describing primary/secondary pairing behavior.
# - Gauge-level significance report listing all constituents with p < 0.1.
#
...
print(f"Stations after 1950-1980 filter: {stations_after_date_filter}")
...
for i, col in enumerate(columns):
    ...
    plot_gauges(dep_df_p, dep_df, col, "enhanced_1950-1980", subplot_label)
...
if significance_data:
    ...
    # Save to CSV
    significance_df.to_csv('gauge_significance_report_1950.csv', index=False)
